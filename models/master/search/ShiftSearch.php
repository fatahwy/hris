...
/**
 * ShiftSearch represents the model behind the search form of `app\models\master\Shift`.
 */
class ShiftSearch extends Shift
{
    ...
    {
        return [
            [['id_shift', 'id_company'], 'integer'],
            [['name', 'checkin_start', 'workhour_start', 'workhour_end', 'color', 'note', 'created_at', 'updated_at'], 'safe'],
        ];
    }
